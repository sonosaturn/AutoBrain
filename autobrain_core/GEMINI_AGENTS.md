...
This project is indexed by GitNexus as **secondo_cervello_ai** (340 symbols, 437 relationships, 15 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
